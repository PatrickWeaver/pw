...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryItem.caption'
        db.add_column(u'gallery_galleryitem', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryItem.caption'
        db.delete_column(u'gallery_galleryitem', 'caption')
